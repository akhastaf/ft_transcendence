  ...
  const CardSection : React.FC <{
    ...
    return <>
     <div className="items-center  bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
            <img className="w-[250px] h-[20rem] rounded-lg sm:rounded-none sm:rounded-l-lg object-cover" src={img} alt={`${name}`}/>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="https://profile.intra.42.fr/users/mokhames">{name}</a>
                  </h3>
                  ...
                  <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="https://profile.intra.42.fr/users/mokhames" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
