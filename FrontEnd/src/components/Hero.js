...
function Hero() {
  return (
    ...
    <div className="bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 pb-8 md:pb-0 lg:flex lg:flex-col lg:items-center paa">
