...
export class BaseMigration1660571188940 implements MigrationInterface {
    name = 'BaseMigration1660571188940'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "twofa" boolean NOT NULL DEFAULT false, "secret" character varying, "recoveryCode" character varying, "avatar" character varying NOT NULL, "status" "public"."user_status_enum" NOT NULL DEFAULT 'offline', "win" integer NOT NULL, "loss" integer NOT NULL, "level" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
