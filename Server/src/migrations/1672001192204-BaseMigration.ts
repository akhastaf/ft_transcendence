...
export class BaseMigration1672001192204 implements MigrationInterface {
    name = 'BaseMigration1672001192204'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."game_status_enum" AS ENUM('waiting', 'playing', 'end', 'pause')`);
        await queryRunner.query(`CREATE TYPE "public"."game_mode_enum" AS ENUM('classic', 'custom')`);
        await queryRunner.query(`CREATE TABLE "game" ("id" SERIAL NOT NULL, "room" character varying, "status" "public"."game_status_enum" NOT NULL DEFAULT 'waiting', "mode" "public"."game_mode_enum" NOT NULL DEFAULT 'classic', "score1" integer NOT NULL DEFAULT '0', "score2" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "player1Id" integer, "player2Id" integer, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "usertogroup" ADD CONSTRAINT "FK_3401fb356f6be5ffbddbbdb0005" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "usertogroup" ADD CONSTRAINT "FK_5b4f66801c1a3b31c251f3447e4" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Message" ADD CONSTRAINT "FK_2bb6aae64e0ff3bdf45d6deabfe" FOREIGN KEY ("senderId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Message" ADD CONSTRAINT "FK_54bae27a1b1f1e0da2191df3c58" FOREIGN KEY ("receiverId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "game" ADD CONSTRAINT "FK_7b7f91302f66ab534423c96aa34" FOREIGN KEY ("player1Id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "game" ADD CONSTRAINT "FK_3b85329cbe5b9f9002f05018faf" FOREIGN KEY ("player2Id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_bloked_user" ADD CONSTRAINT "FK_be9d65d2e3ce1d773fab16ac950" FOREIGN KEY ("userId_2") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
