...
export class BaseMigration1672348751807 implements MigrationInterface {
    name = 'BaseMigration1672348751807'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "groups" ("id" SERIAL NOT NULL, "privacy" "public"."groups_privacy_enum" NOT NULL DEFAULT 'public', "name" character varying NOT NULL, "avatar" character varying NOT NULL DEFAULT 'http://localhost:3000/uploads/group.jpeg', "description" character varying, "password" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" integer, CONSTRAINT "UQ_664ea405ae2a10c264d582ee563" UNIQUE ("name"), CONSTRAINT "PK_659d1483316afb28afd3a90646e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('online', 'offline', 'playing')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "nickname" character varying NOT NULL, "username" character varying NOT NULL, "email" character varying NOT NULL, "twofa" boolean NOT NULL DEFAULT false, "secret_tmp" character varying, "secret" character varying, "recoveryCode" character varying, "avatar" character varying NOT NULL DEFAULT 'http://localhost:3000/uploads/avatar.png', "status" "public"."users_status_enum" NOT NULL DEFAULT 'offline', "win" integer NOT NULL DEFAULT '0', "loss" integer NOT NULL DEFAULT '0', "level" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ad02a1be8707004cb805a4b5023" UNIQUE ("nickname"), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "achievments" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "icon" character varying NOT NULL, "description" character varying NOT NULL, "level" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d7d04156611d9693fd2f02b16b2" PRIMARY KEY ("id"))`);
